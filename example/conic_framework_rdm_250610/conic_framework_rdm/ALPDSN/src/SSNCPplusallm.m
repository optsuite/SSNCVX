...
%% Compute projection
if trans.isL
    [F, S,Zb,trans] = compute_gradplus(K, X, y, Zb,q, b, C, trans);
else
...
if trans.isL
    for iter = 1:maxits
        ...
        [Fnew,Snew,Zbnew,trans] = compute_gradplus(K,Xnew,ynew,Zbnew,qnew,b,C,trans);
...
function [F,S,Zb,trans] = compute_gradplus(K,X,y,Zb,q,b,C,trans)
